Shader "lilToonRefractionBlur"
{
    Properties
    {
        ...
        _RefractionFresnelPower ("sRefractionFresnel", Range(0.01, 10)) = 0.5
        _RefractionColorFromMain ("sColorFromMain", Int) = 0
    ...
    SubShader
    {
        ...
        CGINCLUDE
        #define LTSKKS_REFRACTION 1
        #define LTSKKS_REFRACTION_BLUR 1
        ENDCG
