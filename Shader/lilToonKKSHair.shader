Shader "lilToonKKSHair"
{
    Properties
    {
        ...
        _VertexLightStrength ("sVertexLightStrength", Range(0, 1)) = 1
    ...
    SubShader
    {
        ...
        UsePass "lilToonOnePassTransparent/SHADOW_CASTER"
        UsePass "lilToonOnePassTransparent/SHADOW_CASTER_OUTLINE"
    }
