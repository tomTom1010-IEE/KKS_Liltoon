Shader "lilToonTessellationTwoPassTransparent"
{
    Properties
    {
        // Base
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define LTSKKS_TESS_APPDATA LTSKKSAppData
            #define LTSKKS_TESS_OUTPUT LTSKKSV2F
            #include "Includes/LTSKKSForward.cginc"
            #include "Includes/LTSKKSTessellation.cginc"
            ENDCG
        }
        ...
        Pass
        {
            ...
            #define LTSKKS_TESS_OUTPUT LTSKKSDepthV2F
        ...
        Pass
        {
            ...
            #define LTSKKS_RENDER_TWOPASS_TRANSPARENT 1
            #define LTSKKS_TESS_APPDATA LTSKKSOutlineAppData
            #define LTSKKS_TESS_OUTPUT LTSKKSOutlineV2F
        ...
        Pass
        {
            ...
            #define LTSKKS_RENDER_TWOPASS_TRANSPARENT 1
            #define LTSKKS_TESS_APPDATA appdata_full
            #define LTSKKS_TESS_OUTPUT LTSKKSShadowV2F
        ...
        Pass
        {
            ...
            #define LTSKKS_TESS_APPDATA LTSKKSOutlineAppData
            #define LTSKKS_TESS_OUTPUT LTSKKSOutlineShadowV2F
            #include "Includes/LTSKKSOutline.cginc"
            #include "Includes/LTSKKSTessellation.cginc"
            ENDCG
        }
